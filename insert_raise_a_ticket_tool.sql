...
VALUES (
    ...
    'raise-a-ticket',
    'Creates a support ticket by posting to http://localhost:3000/create-a-ticket. Use this whenever the user reports any issue. The reason should be a clear and descriptive summary of the problem the user is facing.',
    '{"curl": "curl -X POST \"http://localhost:3000/create-a-ticket\" -H \"Content-Type: application/json\" -d '\''{}'\''"}'::jsonb,
    NOW()
)
